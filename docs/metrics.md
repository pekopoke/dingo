...
| `LLMTextQualityV8` | LLMTextQualityV8 | Multi-label impact-driven text quality evaluation for LLM pretraining with a self-contained prompt. | [WanJuanSiLu: A High-Quality Open-Source Webtext Dataset for Low-Resource Languages](https://arxiv.org/abs/2501.14506) (Yu et al., 2025) | [📊 See Results](eval/prompt/redpajama_data_evaluated_by_prompt.md) | [📝 View Example](../examples/llm_and_rule/llm_local.py) |
